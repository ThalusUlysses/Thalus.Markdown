...
{
    /// <summary>
    /// Implements the <see cref="Markdown"/> functionality as dependency object
    /// </summary>
    public class Markdown : DependencyObject
    {
        ...
        public Markdown()
        {
            ...
            AssetPathRoot = $"{Environment.CurrentDirectory}\\assets";
        }
        ...
        /// 
        /// </summary>
        public static Regex ImageInline = new Regex(string.Format(@"
